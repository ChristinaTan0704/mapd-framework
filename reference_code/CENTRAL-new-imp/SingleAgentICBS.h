...
public:
	...
	*/
	...
	SingleAgentICBS(int start_location, int goal_location, int park_location, const bool* my_map, int map_size, const int* moves_offset, int num_col, const vector<vector<int> > &cons_paths, int curr_time, int max_time);
	~SingleAgentICBS();
