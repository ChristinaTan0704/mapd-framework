...
public:
    ...
    int task_frequency;
    int task_release_period;
    vector<int> path_planning_timestep;
    vector<double> task_planning_time_list;
	vector<double> path_planning_time_list;
    vector<int> throughput_per_timestep;
    vector<int> throughput_accumulate;
    ...
    void update_goal_lens(const std::vector<int>& MAPF_paths);
